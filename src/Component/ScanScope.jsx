...
const ScanScope = () => {
    ...
    const resetForm = () => {
        ...
        document.getElementById("marketCapFrom").value = "";
        document.getElementById("marketCapTo").value = "";
        document.getElementById("liquidityFrom").value = "";
        document.getElementById("liquidityTo").value = "";
        document.getElementById("burnedSolFrom").value = "";
        document.getElementById("burnedSolTo").value = "";
        document.getElementById("LockedLiquidity").Checked = false;
        document.getElementById("FreezableToken").Checked = false;
        const checkbox = document.querySelector("#LockedLiquidity").previousElementSibling;
        if (checkbox) {
              ...
              <form>
                ...
                <table class="w-full max-w-[600px] mx-auto">
                    ...
                    <tr>
                        ...
                        <div>
                            <span class="ms-3 text-xs font-normal text-gray-900 dark:text-gray-300 mr-10">From</span>
                            <input type="number" id="liquidityFrom" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg 
                            focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                        </div>
                        </td>
                        ...
                        <div>
                            <span class="ms-3 text-xs font-normal text-gray-900 dark:text-gray-300 mr-10">To</span>
                            <input type="number" id="liquidityTo" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg 
                            focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                        </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <div>
                            <span class="ms-3 text-xs font-normal text-gray-900 dark:text-gray-300 mr-10">From</span>
                            <input type="number" id="burnedSolFrom" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg 
                            focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                        </div>
                        </td>
                        ...
                        <div>
                            <span class="ms-3 text-xs font-normal text-gray-900 dark:text-gray-300 mr-10">To</span>
                            <input type="number" id="burnedSolTo" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg 
                            focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                        </div>
                        </td>
                    ...
                    <div class="mt-7">
                        ...
                        <div id="LockedLiquidity" class="relative w-14 h-7 bg-gray-200 peer-focus:outline-none ring-4 ring-blue-200 
                    ...
                    <div class="mt-7">
                        ...
                        <div id="FreezableToken" class="relative w-14 h-7 bg-gray-200 peer-focus:outline-none  ring-4 ring-blue-200 
                        dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full 
                        rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 
                        after:start-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all 
                        dark:border-gray-600 peer-checked:bg-blue-600 dark:peer-checked:bg-blue-600"></div>
                    ...
                    <tr class="pt-10">
                        <td colspan="2" class="w-full">
                            <div class="mt-10 w-full flex justify-end gap-3">        
                                ...
                                <button type="button" onClick={resetForm} class="text-white bg-[#3B82F6] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Reset</button>  
                            </div> 
                        </td>
                    </tr>
